...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     1,
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     12, 'Colour\'s five hues from th\' eyes their sight will take;
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     20, 'When we renounce learning we have no troubles.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     29, 'If any one should wish to get the kingdom for himself, and to effect this by what he does, I see that he will not succeed. The kingdom is a spirit-like thing, and cannot be got by active doing. He who would so win it destroys it; he who would hold it in his grasp loses it.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     30, 'He who would assist a lord of men in harmony with the Tao will not assert his mastery in the kingdom by force of arms. Such a course is sure to meet with its proper return.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     31, 'Now arms, however beautiful, are instruments of evil omen, hateful, it may be said, to all creatures. Therefore they who have the Tao do not like to employ them.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     32, 'The Tao, considered as unchanging, has no name.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     33, 'He who knows other men is discerning; he who knows himself is intelligent. He who overcomes others is strong; he who overcomes himself is mighty. He who is satisfied with his lot is rich; he who goes on acting with energy has a (firm) will.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     35, 'To him who holds in his hands the Great Image (of the invisible Tao), the whole world repairs. Men resort to him, and receive no hurt, but (find) rest, peace, and the feeling of ease.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     38, '(Those who) possessed in highest degree the attributes (of the Tao) did not (seek) to show them, and therefore they possessed them (in fullest measure). (Those who) possessed in a lower degree those attributes (sought how) not to lose them, and therefore they did not possess them (in fullest measure).
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     42, 'The Tao produced One; One produced Two; Two produced Three; Three produced All things. All things leave behind them the Obscurity (out of which they have come), and go forward to embrace the Brightness (into which they have emerged), while they are harmonised by the Breath of Vacancy.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     46, 'When the Tao prevails in the world, they send back their swift horses to (draw) the dung-carts. When the Tao is disregarded in the world, the war-horses breed in the border lands.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     47, 'Without going outside his door, one understands (all that takes place) under the sky; without looking out from his window, one sees the Tao of Heaven. The farther that one goes out (from himself), the less he knows.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     48, 'He who devotes himself to learning (seeks) from day to day to increase (his knowledge); he who devotes himself to the Tao (seeks) from day to day to diminish (his doing).
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     50, 'Men come forth and live; they enter (again) and die.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     51, 'All things are produced by the Tao, and nourished by its outflowing operation. They receive their forms according to the nature of each, and are completed according to the circumstances of their condition. Therefore all things without exception honour the Tao, and exalt its outflowing operation.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     52, '(The Tao) which originated all under the sky is to be considered as the mother of them all.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     53, 'If I were suddenly to become known, and (put into a position to) conduct (a government) according to the Great Tao, what I should be most afraid of would be a boastful display.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     55, 'He who has in himself abundantly the attributes (of the Tao) is like an infant. Poisonous insects will not sting him; fierce beasts will not seize him; birds of prey will not strike him.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     57, 'A state may be ruled by (measures of) correction; weapons of war may be used with crafty dexterity; (but) the kingdom is made one\'s own (only) by freedom from action and purpose.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     59, 'For regulating the human (in our constitution) and rendering the (proper) service to the heavenly, there is nothing like moderation.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     60, 'Governing a great state is like cooking small fish.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     61, 'What makes a great state is its being (like) a low-lying, down- flowing (stream);--it becomes the centre to which tend (all the small states) under heaven.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     65, 'The ancients who showed their skill in practising the Tao did so, not to enlighten the people, but rather to make them simple and ignorant.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     70, 'My words are very easy to know, and very easy to practise; but there is no one in the world who is able to know and able to practise them.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     72, 'When the people do not fear what they ought to fear, that which is their great dread will come on them.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     73, 'He whose boldness appears in his daring (to do wrong, in defiance of the laws) is put to death; he whose boldness appears in his not daring (to do so) lives on. Of these two cases the one appears to be advantageous, and the other to be injurious. But
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     74, 'The people do not fear death; to what purpose is it to (try to) frighten them with death? If the people were always in awe of death, and I could always seize those who do wrong, and put them to death, who would dare to do wrong?
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     75, 'The people suffer from famine because of the multitude of taxes consumed by their superiors. It is through this that they suffer famine.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     76, 'Man at his birth is supple and weak; at his death, firm and strong. (So it is with) all things. Trees and plants, in their early growth, are soft and brittle; at their death, dry and withered.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     77, 'May not the Way (or Tao) of Heaven be compared to the (method of) bending a bow? The (part of the bow) which was high is brought low, and what was low is raised up. (So Heaven) diminishes where there is superabundance, and supplements where there is deficiency.
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     79, 'When a reconciliation is effected (between two parties) after a great animosity, there is sure to be a grudge remaining (in the mind of the one who was wrong). And how can this be beneficial (to the other)?
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     80, 'In a little state with a small population, I would so order it, that, though there were individuals with the abilities of ten or a hundred men, there should be no employment of them; I would make the people, while looking on death as a grievous thing, yet not remove elsewhere (to avoid it).
...
INSERT INTO verse (book_id, translation_id, chapter_number, verse_number, body) VALUES
    (90, 202, 1,
     81, 'Sincere words are not fine; fine words are not sincere. Those who are skilled (in the Tao) do not dispute (about it); the disputatious are not skilled in it. Those who know (the Tao) are not extensively learned; the extensively learned do not know it.
